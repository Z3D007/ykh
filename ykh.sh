...
vid
echo " " 
echo -e "$grn                      ▶Coder by$grn David Khant$red◀$rset"
#Functions
echo -e "$grn                         [Ye Khaung Photo]$rset"
echo " "
echo " "
}
menu(){
...
echo " "
echo " "
echo -e "$blue                        ✔️$cyan [\e[92m1\e[96m] Ye Khaung Photo"
...
clear
echo
echo -e "\e[91m Ye Khaung Sexy Photo Link.
                               

         \e[92mL1NK :- \e[96mhttps://yip.su/2BnsV6.jpg\e[91m

                                 
Copy Link Open Broswer."
echo
